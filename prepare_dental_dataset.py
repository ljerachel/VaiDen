...
def main():
    ...
    print(f"   Note: Class IDs in annotations will be remapped to sequential indices (0, 1, 2, ...)")
    ...
    print("2. Run training with: python train.py --data data/dental_cavities.yaml --weights yolov5s.pt --img 640 --epochs 100")
    print("=" * 60)
